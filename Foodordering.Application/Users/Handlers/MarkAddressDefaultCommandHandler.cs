...
{
    public class MarkAddressDefaultCommandHandler : IRequestHandler<MarkAddressDefaultCommand, List<AddressDto>>
    {
        private readonly IAppDbContext _context;
        private readonly ITokenService _tokenService;

        public MarkAddressDefaultCommandHandler(IAppDbContext context, ITokenService tokenService)
        {
            _context = context;
            _tokenService = tokenService;
        }

        public async Task<List<AddressDto>> Handle(MarkAddressDefaultCommand request, CancellationToken cancellationToken)
        {
